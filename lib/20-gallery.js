 ...
 ******************************************************************************/
var risa = risa || {};
risa.functional = risa.functional || {};
...
(function(){
    ...
    document.getElementsByTagName("body")[0].appendChild(preview_screen);
    ...
    const show_thumbnail = (id, purge) => {
        ...
        const build_menu = (downloadable) => {
            ...
            menu.appendChild(previousButton);
        ...
        if (purge) {
            do_purge();
            preview_screen.appendChild(build_menu());
        }
        ...
        img.onload = () => {
            ...
            dflag.appendChild(img);
            dflag.appendChild(build_menu(true));
            while (preview_screen.hasChildNodes()) {
                preview_screen.removeChild(preview_screen.lastChild);
            }
            preview_screen.appendChild(dflag);
        };
